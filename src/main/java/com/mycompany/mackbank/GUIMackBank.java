...
public class GUIMackBank extends JFrame {
    ...
    private JTextField regEmailField = new JTextField(20);
...
private void handleRegister() {
    ...
    private void handlePredictor() {
        ...
        calculateButton.addActionListener(e -> {
            try {
                ...
                double result = predictor.calculateInterest();
                String formattedResult = String.format("RM %.2f", result);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new GUIMackBank().setVisible(true);
        });
    }
}